<section>
    ...
    <div class="aboutContDiv">
        ...
        <span>About SurGIS of Texas Corporation</span>
        <p>As a family owned surveying corporation, we pride ourselves on our ability to provide a solution for all of your surveying requirements. 
        Our licensed professional land surveyors have over 40 years of surveying experience, perform work all across Texas and consistently adhere to all government regulations, 
        follow our clients’ exact specifications, and are committed to exceeding your expectations.</p>
        <a href="/about-surgis.php">More About Us</a>
    </div>

    <div class="surveys">

        <div class="backgroundimageforopacityssake"></div>
