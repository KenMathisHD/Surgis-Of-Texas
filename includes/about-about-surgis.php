<section>
    ...
    <div class="aboutAbout">
        ...
        <p>This is why SurGIS of Texas has such focus on bringing integrity back to land surveying. Every survey we complete is done with the understanding that this is 
            the base of our clients project. Everything done afterwards, whether it be transferring a land title, putting in a new well or building a courthouse is 
        ...
        <div class="commitments">
            ...
            <p><i>Our commitment to our clients – to execute the demands and goals of our client in a manner to promote our clients product or service and through 
                technology, enhance and improve our clients’ resources and profits.</i></p>

            <p><i>Our commitment to our employees – improve working conditions, atmosphere and the needs of our employees through education and a more flexible work 
                ethic.</i></p>

            <p><i>Our commitment to the public – as surveyors we accept the ethic responsibilities to our clients. As surveyors we also have a responsibility to the 
                public in assuring that we follow the regulations set forth by the Texas Board of Professional Land Surveyors and the Laws of the State of Texas.</i></p>
        </div>
        ...
        <div class="aboutServices">
            ...
            <a href="/services-surgis.php" class="servButtonLink">Learn more about our services</a>
        </div>
