<footer>
    ...
    <div class="bottomNav">
        ...
        <div id="sec2" class="firmLicense">
            ...
            <ul>
                <li>Tx Board of Prof Eng & Land Surveyors</li>
        ...
        <div id="sec3">
            ...
            <ul>
                ...
                <li>12274 Bandera Rd Ste 123</li>
                <li>Helotes, TX 78023</li>
                <li><a href="tel:2103675843">(210) 367-5843</a></li>
    ...
    <div class="copyright-box">
        <span id="copyright">&copy; 2020 SurGIS of Texas Corporation - All Rights Reserved </span>
        <!-- <span>Texas Board of Professional Engineers and Land Surveyors Firm License #10193840</span> -->
    </div>
