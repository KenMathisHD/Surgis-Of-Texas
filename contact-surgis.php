...
<head>
    ...
    <?php include($includes . "contact-head-surgis.php"); ?>           <!--this is pulling in the html built in the head.php file. the 'include' is just like javascriprts '+=' - it adds thing to the existing variable  -->              
</head>
...
<body>
    ...
    <main>
    <?php include($includes . "contact-us-surgis.php"); ?>
    <?php include($includes . "map-marker-surgis.php"); ?>
       
    </main>

    <?php include($includes . "bottomnav-surgis.php"); ?>
    <?php include($includes . "contact-footer-surgis.php"); ?>
